...
interface Props {
  ...
  key:number
  handleEditClick: (e:React.MouseEvent<Element, MouseEvent>, product: categoriesProps) => void
}
...
const  ReadOnlyRowCat:FC<Props>=({ category, key, deleteCategory, handleEditClick }) =>{
  ...
  return (
    <tr key={key} >
      ...
      <td>
        ...
        <button type="button" className="btn btn-outline-primary p-1 m-1 mt-2" onClick={(e) => handleEditClick(e, category)}><MdOutlineModeEdit className='mb-1' /></button>
      </td>
